<template>
  <v-data-table :headers="headers" :items="surveys" class="elevation-9 mx-3"
    rows-per-page-text="" :loading="$store.state.loading" :disable-initial-sort="disableInitialSort">
